...
@SourceType(value = "CertiniaARP", label = "Certinia",uiConfig = "certinia-layout.json")
public class CertiniaConf extends AbstractArpConf<CertiniaConf> {
  private static final String ARP_FILENAME = "arp/implementation/certinia-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.certinia.CertiniaDriver";
